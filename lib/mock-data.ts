...
export const mockServices = [
  {
    id: "svc_wash",
    name: "Storefront Wash",
    duration: "~45 min",
    description: "Full exterior wash of your storefront glass and signage area",
  ...
  },
  {
    ...
    name: "Sidewalk & Curb",
    duration: "~30 min",
    description: "High-pressure sidewalk cleaning and curb scrub",
    price: "Included in plan",
    icon: "waves",
  },
  {
    ...
    name: "Banner & Signage",
    duration: "~25 min",
    description: "Hand-clean banners, awnings, and exterior signage",
    price: "Included in plan",
    icon: "flag",
  },
  {
    ...
    duration: "~2 hrs",
    description: "Complete exterior deep clean including grout and hard surfaces",
